          	...
          	<!-- contact form -->
                        <div class="add-comment contact-form">
                            ...
                            <div class="comment-form">
                             <form method="POST" action="<?php echo $_SERVER['PHP_SELF']?>" id="car">
                                ...
                                <div class="row rowSubmit">
	                                ...
	                                <a onclick="document.getElementById('car').reset();return false" href="#" class="link-reset">Reset all fields</a>
                             	</div>
                            </form>
                            </div>
                        </div>
